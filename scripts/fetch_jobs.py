...
def fetch(query: str) -> bytes:
    ...
    request = urllib.request.Request(url, headers={"User-Agent": "Mozilla/5.0 (compatible; AI-Remote-Finder/2.1; public-search-index-only)", "Accept": "application/rss+xml,application/xml,text/xml;q=0.9,*/*;q=0.8"})
