...
const state={jobs:[],mode:'high',q:'',sort:'best',saved:loadSet('savedJobs'),hidden:loadSet('hiddenJobs'),applied:loadSet('appliedJobs'),meta:{}};
...
function updateHealth(d){
  ...
  const warn=d.provider_configured===false||d.llm_provider_configured===false||(d.query_success||0)<(d.query_total||0)||(d.llm_review_failures||0)>0||d.llm_monthly_budget_exhausted===true||(Number.isFinite(h)&&h>24);
